...
def main():
    ...
    #print("-------------------active_resources:", active_resources)
    # env = os.environ.copy()
    ...
    #active_resources = updated_active_resources
    #print("-----------------updated_active_resources:", updated_active_resources)
    ...
    #updated_active_resources = collections.OrderedDict()
    #for hostname in active_resources.keys():
    #    updated_active_resources[hostname] = list(range(16))
    #active_resources = updated_active_resources
    #print("-----------------updated_active_resources:", updated_active_resources)
    ...
    #print("----------------------world_info_base64:", world_info_base64)
