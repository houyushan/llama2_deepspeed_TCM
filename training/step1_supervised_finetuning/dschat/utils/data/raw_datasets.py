...
class GuanacoDataset(PromptRawDataset):
    ...
    def __init__(self, output_path, seed, local_rank, dataset_name):
        super().__init__(output_path, seed, local_rank, dataset_name)
        #self.dataset_name = "JosephusCheung/GuanacoDataset"
        self.dataset_name = "/home/hpcadmin/lilz/llm-llama2/GuanacoDataset/"
        self.dataset_name_clean = "JosephusCheung_GuanacoDataset"
